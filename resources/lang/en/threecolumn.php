...
return [
    ...
    "detail" => "Detail",
     ...
     "habitExamples01" => "(e.g.) The morning fortune-telling lottery was bad. It will be bad for a long time to come.",
     "habitExamples02" => "(e.g.) My lover betrayed me, it is all my fault.",
     "habitExamples03" => "(e.g.) I passed my friend on the street and he didn't speak to me. It's not that I didn't notice, but that my friend doesn't like me.",
     "habitExamples04" => "(e.g.) I hate everything that is wrong with one of them.",
     "habitExamples05" => "(e.g.) People must not hate you. You must meet expectations.",
     "habitExamples06" => "(e.g.) It was just luck that it worked last time, it won't next time.",
     "habitExamples07" => "(e.g.) I don't like that person, he must have a bad character.",
